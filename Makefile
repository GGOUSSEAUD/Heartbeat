...
PROGNAME = SIExemple03
PACKAGE=$(PROGNAME)
VERSION = 1.0
distdir = $(PACKAGE)-$(VERSION)
HEADERS = GL4D/aes.h GL4D/gl4du.h GL4D/gl4dummies.h  GL4D/gl4wdummies.h
SOURCES = window.c GL4D/aes.c GL4D/gl4du.c GL4D/gl4dummies.c
OBJ = $(SOURCES:.c=.o)
DOXYFILE = documentation/Doxyfile
EXTRAFILES = COPYING shaders/basic.vs shaders/basic.fs SIExemple03.sln SIExemple03.vcxproj SIExemple03.dev
